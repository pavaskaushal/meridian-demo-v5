...
/* ── VENDOR RISK DATA ───────────────────────────────────── */
var VENDOR_DATA = [
    { name: 'Huawei Technologies', spend: 612, risk: 42, status: 'MEDIUM', flag: false, category: 'Network', financial: 72, operational: 58, compliance: 64, riskDetail: 'Geopolitical supply risk — single-source 5G RAN dependency. Equipment lead time extended to 18 weeks.', action: 'Qualify Ericsson as secondary 5G RAN vendor. Target 60/40 split by Q4 FY26.' },
    { name: 'Nokia Solutions', spend: 284, risk: 18, status: 'LOW', flag: false, category: 'Network', financial: 88, operational: 82, compliance: 90, riskDetail: 'No significant risk flags. Strong delivery track record.', action: 'Continue standard monitoring.' },
    { name: 'Ericsson India', spend: 198, risk: 22, status: 'LOW', flag: false, category: 'Network', financial: 84, operational: 78, compliance: 86, riskDetail: 'Minor delivery delays on 5G small cell orders. Within SLA thresholds.', action: 'Monitor delivery timelines for Q3 5G rollout commitments.' },
    { name: 'Indus Towers', spend: 228, risk: 28, status: 'LOW', flag: false, category: 'Infrastructure', financial: 76, operational: 72, compliance: 80, riskDetail: 'Tower sharing agreement renewal due Q3. No current compliance issues.', action: 'Begin renegotiation of tower sharing SLA 60 days ahead of renewal.' },
    { name: 'CloudHost Infra Ltd', spend: 1.92, risk: 94, status: 'CRITICAL', flag: true, category: 'IT', financial: 12, operational: 18, compliance: 8, riskDetail: 'OFAC screening flag raised. Split PO fraud — ₹1.92 Cr PO split into 4 sub-threshold POs to bypass approval.', action: 'Immediately suspend new POs. Escalate to CFO and Legal. File SAR with compliance team.' },
    { name: 'TowerCo Solutions', spend: 28, risk: 38, status: 'MEDIUM', flag: false, category: 'Infrastructure', financial: 62, operational: 66, compliance: 70, riskDetail: 'Moderate financial leverage. SLA compliance at 96.4% vs 99% contracted.', action: 'Issue SLA improvement notice. Review at next quarterly vendor review.' },
    { name: 'SAP India', spend: 84, risk: 12, status: 'LOW', flag: false, category: 'Software', financial: 92, operational: 88, compliance: 94, riskDetail: 'No risk flags. Tier-1 vendor with strong governance.', action: 'Continue standard monitoring.' },
    { name: 'Oracle India', spend: 62, risk: 14, status: 'LOW', flag: false, category: 'Software', financial: 90, operational: 86, compliance: 92, riskDetail: 'No risk flags. Licence renewal due FY27.', action: 'Begin licence renegotiation 6 months ahead of renewal for better pricing.' },
    { name: 'Accenture India', spend: 142, risk: 18, status: 'LOW', flag: false, category: 'Services', financial: 86, operational: 82, compliance: 88, riskDetail: 'No significant flags. High attrition on dedicated Apex team (28%).', action: 'Request team stability commitments in next contract renewal.' },
    { name: 'Subex Ltd', spend: 28, risk: 16, status: 'LOW', flag: false, category: 'Software', financial: 84, operational: 80, compliance: 86, riskDetail: 'Licence renewal Q3 — proposed 18% cost increase flagged.', action: 'Benchmark against alternative RAFM vendors before renewal negotiation.' },
    { name: 'Tata Consultancy', spend: 186, risk: 20, status: 'LOW', flag: false, category: 'Services', financial: 88, operational: 84, compliance: 90, riskDetail: 'No risk flags. Strong delivery performance.', action: 'Continue standard monitoring.' },
    { name: 'IBM India', spend: 94, risk: 24, status: 'LOW', flag: false, category: 'Software', financial: 82, operational: 76, compliance: 84, riskDetail: 'Minor delays on IT infrastructure refresh project. Within tolerance.', action: 'Monitor project milestone delivery for Q2.' },
    { name: 'Wipro Ltd', spend: 112, risk: 22, status: 'LOW', flag: false, category: 'Services', financial: 84, operational: 80, compliance: 86, riskDetail: 'No significant flags. Resource ramp-up delays on digital project.', action: 'Confirm resource plan for digital transformation programme Q3.' },
    { name: 'Amdocs India', spend: 68, risk: 32, status: 'MEDIUM', flag: false, category: 'Software', financial: 68, operational: 64, compliance: 72, riskDetail: 'BSS upgrade project 3 weeks behind schedule. Change request backlog growing.', action: 'Escalate project delays to vendor VP. Enforce liquidated damages clause if Q3 milestone missed.' },
    { name: 'NetCracker Tech', spend: 44, risk: 28, status: 'MEDIUM', flag: false, category: 'Software', financial: 72, operational: 68, compliance: 74, riskDetail: 'Parent company NEC undergoing restructuring. Support continuity risk.', action: 'Request business continuity plan from vendor. Identify fallback support options.' },
    { name: 'Comviva Technologies', spend: 38, risk: 19, status: 'LOW', flag: false, category: 'Software', financial: 80, operational: 78, compliance: 82, riskDetail: 'No significant flags.', action: 'Continue standard monitoring.' },
    { name: 'Tech Mahindra', spend: 156, risk: 26, status: 'LOW', flag: false, category: 'Services', financial: 80, operational: 76, compliance: 82, riskDetail: 'No significant flags. Good delivery track record on network services.', action: 'Continue standard monitoring.' },
    { name: 'GTL Infrastructure', spend: 82, risk: 58, status: 'MEDIUM', flag: true, category: 'Infrastructure', financial: 38, operational: 54, compliance: 62, riskDetail: 'Financial distress flag — debt restructuring underway. Tower availability SLA at 94.2% vs contracted 99%.', action: 'Activate contingency tower sharing with Indus for critical sites. Monitor monthly financials.' },
    { name: 'Sterlite Power', spend: 54, risk: 44, status: 'MEDIUM', flag: false, category: 'Infrastructure', financial: 58, operational: 62, compliance: 66, riskDetail: 'Ongoing NCLT proceedings on parent entity. Supply chain delays on fibre orders.', action: 'Dual-source critical fibre requirements. Monitor NCLT proceedings monthly.' },
    { name: 'Mahindra Infra', spend: 36, risk: 35, status: 'MEDIUM', flag: false, category: 'Infrastructure', financial: 66, operational: 68, compliance: 72, riskDetail: 'Moderate risk. Some SLA slippage on civil works.', action: 'Issue performance improvement notice for civil works delays.' },
    { name: 'Azure Power', spend: 28, risk: 18, status: 'LOW', flag: false, category: 'Energy', financial: 82, operational: 80, compliance: 84, riskDetail: 'No risk flags. Solar supply stable.', action: 'Continue standard monitoring.' },
    { name: 'Quess Corp', spend: 22, risk: 30, status: 'MEDIUM', flag: false, category: 'Services', financial: 68, operational: 70, compliance: 72, riskDetail: 'High field staff attrition impacting service continuity. 34% annual attrition on Apex account.', action: 'Request dedicated account team with retention incentives in next contract.' },
    { name: 'SkyTel Networks', spend: 8.4, risk: 88, status: 'CRITICAL', flag: true, category: 'IT', financial: 22, operational: 14, compliance: 10, riskDetail: 'GST compliance failure — 3 consecutive quarters of non-filing. MCA21 flag for director disqualification.', action: 'Terminate contract after 30-day notice. Do not renew or issue new POs.' }
];
